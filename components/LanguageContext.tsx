...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    step_2: "2. Cấu Hình",
    step_3: "3. Góc Nhìn",
    model_select: "Chọn Model Render",
    model_gemini: "Gemini 2.0 Flash (Đa năng)",
    model_imagen: "Imagen 3 (Chuyên tạo ảnh)",
    res_title: "Kết Quả",
    ...
    login_title: "Đăng Nhập CPGVN",
    login_desc: "Vui lòng cung cấp thông tin của bạn để yêu cầu quyền truy cập hệ thống.",
    login_name: "Họ và tên",
    login_email: "Email liên hệ",
    login_position: "Vị trí / Chức danh tại CPG",
    login_btn: "Gửi Yêu Cầu Kích Hoạt",
    login_waiting_title: "Please wait for approval / Vui lòng chờ phê duyệt",
    login_waiting_desc: "Your account is currently being reviewed. Please wait for an administrator to approve your request. / Tài khoản của bạn đang được xem xét. Vui lòng chờ quản trị viên phê duyệt.",
    login_error: "Vui lòng điền đầy đủ các thông tin.",
    login_success: "Thông tin đã được ghi nhận thành công!",
    login_enter_code: "Enter Activation Code / Nhập mã kích hoạt:",
    login_invalid_code: "Invalid code / Mã không hợp lệ",
  },
  en: {
    app_title: "CPGVN",
    ...
    step_1: "1. Upload",
    step_2: "2. Configure",
    step_3: "3. Perspective",
    model_select: "Select Render Model",
    model_gemini: "Gemini 2.0 Flash (Versatile)",
    model_imagen: "Imagen 3 (High Quality Images)",
    res_title: "Result",
    ...
    login_title: "CPGVN Login",
    login_desc: "Please provide your information to request access to the system.",
    login_name: "Full Name",
    login_email: "Contact Email",
    login_position: "Position / Title at CPG",
    login_btn: "Send Activation Request",
    login_waiting_title: "Please wait for approval / Vui lòng chờ phê duyệt",
    login_waiting_desc: "Your account is currently being reviewed. Please wait for an administrator to approve your request. / Tài khoản của bạn đang được xem xét. Vui lòng chờ quản trị viên phê duyệt.",
    login_error: "Please fill in all information.",
    login_success: "Information has been recorded successfully!",
    login_enter_code: "Enter Activation Code",
