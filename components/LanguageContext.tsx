...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    api_key_desc: "Bạn cần cung cấp Gemini API Key cá nhân để sử dụng ứng dụng này. Key được lưu an toàn trong bộ nhớ trình duyệt (localStorage).",
  ...
  en: {
    ...
    api_key_desc: "You need to provide your personal Gemini API Key to use this app. The key is stored securely in your browser's local storage.",
